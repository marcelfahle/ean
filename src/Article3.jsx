    ...
    return(
      <main>
        <article className="article">
          ...
          <p className="article__date">July 21, 2016</p>

          <h2 className="article__title">Satellite constructed on schedule for Inmarsat’s ‘ground-breaking’ European Aviation Network</h2>
          ...
          <p>
            ...
            <figure>
              <img src="./img/a03i1.jpg" alt="Thales Alenia Space assembles the communication module of Inmarsat’s European Aviation Network satellite" />
              <figcaption> Thales Alenia Space assembles the communication module of Inmarsat’s European Aviation Network satellite
                Photo Source: Thales Alenia Space/Imag[IN]</figcaption>
            </figure>
          ...
          <p>
            Jonathan Sinnatt/Alison Stokes<br/>
            Inmarsat Corporate Communications<br/>
            <a href="mailto:jonathan.sinnatt@inmarsat.com">jonathan.sinnatt@inmarsat.com/</a><br/>
            <a href="mailto:alison.stokes@inmarsat.com">alison.stokes@inmarsat.com</a><br/>
            +44 (0)20 7728 1935/1492
          </p>

          <p>
            Robeel Haq<br/>
            Inmarsat Aviation<br/>
