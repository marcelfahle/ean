    ...
    return(
      <main>
        <article className="article">
          ...
          <p className="article__date">September 21, 2015</p>

          <h2 className="article__title">Deutsche Telekom and Inmarsat partner to deliver European Aviation Network</h2>
          ...
          <ul>
            <li>World’s first combined LTE-based ground network and satellite network dedicated to aviation passenger connectivity in Europe</li>
            <li>Customer experience similar to the comfort of high-speed broadband at home</li>
            <li>Lufthansa will offer satellite-based connectivity on board European flights in 2016 and commits to flight test program for the European Aviation Network in 2017</li>
          </ul>
